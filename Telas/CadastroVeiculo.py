...
class Application2():
    ...
    # Criação da label de entrada do código
        # Id Veículo
        self.lb_IdVeiculo = Label(self.TelaCadastroVeiculo, text='ID VEÍCULO',font=('Segoe UI Semibold', 11))
        ...
        # Placa
        self.lb_Placa= Label(self.TelaCadastroVeiculo, text='PLACA',font=('Segoe UI Semibold', 11))
        ...
        self.Placa_entry.place(relx=0.30, rely=0.28, relwidth=0.15, relheight=0.06)
        # Tipo de Veículo
        self.lb_TipoVeiculo= Label(self.TelaCadastroVeiculo, text='TIPO DE VEÍCULO',font=('Segoe UI Semibold', 11))
        ...
        self.TipoVeiculo_entry.place(relx=0.51, rely=0.28, relwidth=0.15, relheight=0.06)
        # Tipo de combustível
        self.lb_TipoCombustivel = Label(self.TelaCadastroVeiculo, text='TIPO DE COMBUSTÍVEL',font=('Segoe UI Semibold', 11))
        ...
        self.TipoCombustivel_entry.place(relx=0.70, rely=0.28, relwidth=0.15, relheight=0.06)
        # Capacidade de Tanque
        self.lb_Tanque = Label(self.TelaCadastroVeiculo, text='CAPACIDADE DE TANQUE',font=('Segoe UI Semibold', 11))
        self.lb_Tanque.place(relx=0.11, rely=0.44, relwidth=0.15, relheight=0.04)
        self.Tanque_entry = Entry(self.TelaCadastroVeiculo, font=('Segoe UI Semibold',9))
        self.Tanque_entry.place(relx=0.11, rely=0.48, relwidth=0.15, relheight=0.06)

        # Data aquisição
        self.lb_DtAquisicao = Label(self.TelaCadastroVeiculo, text='DATA DE AQUISICAO',font=('Segoe UI Semibold', 11))
        self.lb_DtAquisicao.place(relx=0.30, rely=0.44, relwidth=0.15, relheight=0.04)
        self.DtAquisicao_entry = Entry(self.TelaCadastroVeiculo, font=('Segoe UI Semibold',9))
        self.DtAquisicao_entry.place(relx=0.30, rely=0.48, relwidth=0.15, relheight=0.06)
        # Data Baixa
        self.lb_DtBaixa= Label(self.TelaCadastroVeiculo, text='DATA DE BAIXA',font=('Segoe UI Semibold', 11))
        self.lb_DtBaixa.place(relx=0.51, rely=0.44, relwidth=0.15, relheight=0.04)
        self.DtBaixa_entry = Entry(self.TelaCadastroVeiculo, font=('Segoe UI Semibold',9))
        self.DtBaixa_entry.place(relx=0.51, rely=0.48, relwidth=0.15, relheight=0.06)
        # Indicado ativo
