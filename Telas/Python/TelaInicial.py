...
class Application():
    ...
    def abrir_cadastro_veiculo  (self):
        cadastro_veiculo = CadastroVeiculo.CadastroVeiculo(self.Front)

    def BotaoTela(self):

    # Tela Cadastro de Veículos
        self.CadVeiculo = Button(self.Front,text='Cadastro de Veículos', bg='#D6FADC',font=('Segoe UI Semibold', 11), fg='black',command=self.abrir_cadastro_veiculo)
