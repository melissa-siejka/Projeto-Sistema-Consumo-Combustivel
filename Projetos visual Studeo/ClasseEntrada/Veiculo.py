...
class Veiculo(Base):
    ...
    def CadVeiculo(self, sessinon, numeroPlaca, dataAquisicao, dataBaixa, capacidadetanque, inAtivo, codUnidade, codTipoVeiculo, codTipoCombustivel):
        cadVeiculo = Veiculo(sessinon = sessinon, 
