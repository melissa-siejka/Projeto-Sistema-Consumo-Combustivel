...
class VeiculoMotorista(Base):
    ...
    def CadVeicMotorista(self, IdVeiculo, CodMotorista, DataVinculo, DataDesvinculo):

        cadveiculomotorista = VeiculoMotorista(IdVeiculo = IdVeiculo,
                                               CodMotorista = CodMotorista,
                                               DataVinculo = DataVinculo,
                                               DataDesvinculo = DataDesvinculo
                                               )
        Session.add(cadveiculomotorista)
        Session.commit()
        return cadveiculomotorista
