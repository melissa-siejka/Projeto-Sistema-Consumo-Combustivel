...
class UnidadeVeiculo(Base):
    ...
    def CadVeicUnidade(self, id_veiculo, cd_unidade, dt_vinculo, dt_desvinculo):
        cadveicunidade = UnidadeVeiculo(
            id_veiculo = id_veiculo,
            cd_unidade = cd_unidade,
            dt_vinculo = dt_vinculo,
            dt_desvinculo = dt_desvinculo
        )

        Session.add(cadveicunidade)
        Session.commit()
        return cadveicunidade